...
#===========================GRCh38 sequence orientated annotation =============== 
        ...
        check_call(["bash run_predict.sh " + tempdir + "/infile.hg38.vcf.merged.txt " + python_path],shell=True)
        check_call(["mv ./output/infile.log.foldchange " + tempdir + "/infile.log.foldchange"],shell=True)
